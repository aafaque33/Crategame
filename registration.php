                ...
                if(count($_POST) > 0)
                {
                    ...
                    if(isset($err))
                    {
                        ...
                        foreach ($err as $key => $value) {
                            if($key == 'name')
                            {
                                echo '<div class="errorbox error"><span>error: </span>CTag should have Alpha Numeric Character and less than 32 characters only and not be empty</div>';
                            }
                            if($key == 'email')
                            {
                            ...
                            if( !(isset($_SESSION['name'])))
                            {
                                ...
                                ?>  
                                    ...
                                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                        ...
                                        <p><label for="name">Tag: *</label> 
                                        <input class="input" type="text" name="name" value="<?php print $name ?>"></p><br />
